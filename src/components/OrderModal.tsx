...
function Confetti() {
  const particles = Array.from({ length: 35 }, (_, i) => ({
    ...
    color: ['#FF69B4', '#FFB6C1', '#FADADD', '#FF91A4', '#F8E8EE'][i % 5],
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      {particles.map((p) => (
        <motion.div
          ...
          animate={{ y: '110%', rotate: 360 + Math.random() * 360, opacity: [1, 1, 0] }}
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 25px 60px rgba(255, 105, 180, 0.2), 0 0 0 1px rgba(255, 182, 193, 0.15)',
            }}
          >
            <Confetti />
            ...
            <div className="relative z-10 text-center">
              ...
              <motion.p
                ...
                className="text-sm text-pink-400/70 mb-5"
              >
              ...
              <motion.div
                ...
                className="bg-pink-50/60 rounded-2xl p-4 max-h-40 overflow-y-auto"
              >
                <div className="space-y-2">
                  {items.map((item, i) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-pink-700 flex-1 text-left">{item.name}</span>
                      <span className="text-xs text-pink-400/60">¥0</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
              ...
              >
                <span className="text-sm text-pink-400/70">合计</span>
                <div className="flex items-center gap-2">
                  <span className="text-xs text-pink-300/50 line-through">
              ...
              <motion.p
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="text-xs text-pink-300/60 mt-3 italic"
              >
                "因为是你，所以免费~"
              </motion.p>
            </div>
